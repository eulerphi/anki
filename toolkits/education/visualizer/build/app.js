...
var $author$project$Main$shuffleString = function (str) {
	return A3(
		$elm$core$List$foldr,
		...
		A2(
			...
			$elm$core$Array$toList(
				function (fn) {
					return fn(
						$elm$random$Random$initialSeed(45));
				}(
					$elm$random$Random$step(
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			val: $author$project$Main$shuffleString('with')
		},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$view = function (m) {
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(m.val)
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[]}}}}})}});}(this));